...
const SOURCES: &[Source] = &[
    ...
    source!("desktop/android_build_bootstrap.py"),
    ...
    source!("desktop/native/windows-installed-native/src/ui.rs"),
    source!("desktop/native/windows-installed-native/src/ui_startup_data.rs"),
    source!("desktop/offline_preflight_bootstrap.py"),
    ...
    source!("desktop/src-tauri/src/android_build_owner.rs"),
    source!("desktop/src-tauri/src/android_build_protocol.rs"),
    source!("desktop/src-tauri/src/android_build_shell_tests.rs"),
    source!("desktop/src-tauri/src/android_build_wiring_tests.rs"),
    source!("desktop/src-tauri/src/android_toolchain.rs"),
    ...
    source!("desktop/src-tauri/src/candidate_evidence_protocol.rs"),
    ...
    source!("desktop/src-tauri/src/lifecycle_evidence_protocol.rs"),
    ...
    source!("desktop/src-tauri/src/offline_preflight_owner.rs"),
    source!("desktop/src-tauri/src/offline_preflight_owner_tests.rs"),
    source!("desktop/src-tauri/src/offline_preflight_protocol.rs"),
    source!("desktop/src-tauri/src/offline_preflight_protocol_tests.rs"),
    source!("desktop/src-tauri/src/offline_preflight_shell_tests.rs"),
    source!("desktop/src-tauri/src/passive_management_tests.rs"),
    source!("desktop/src-tauri/src/protocol.rs"),
    source!("desktop/src-tauri/src/release_version_edit_commands.rs"),
    source!("desktop/src-tauri/src/release_version_edit_protocol.rs"),
    source!("desktop/src-tauri/src/release_version_protocol.rs"),
    source!("desktop/src-tauri/src/runtime.rs"),
    source!("desktop/src-tauri/src/saved_command_owner.rs"),
    source!("desktop/src-tauri/src/saved_command_owner_tests.rs"),
    ...
    source!("desktop/src-tauri/src/shell_windows.rs"),
    source!("desktop/src-tauri/src/supervisor.rs"),
    source!("desktop/src-tauri/src/vault_keyring_linux.rs"),
    source!("desktop/src-tauri/src/windows_startup.rs"),
    ...
    source!("desktop/src/androidBuild.ts"),
    source!("desktop/src/androidBuildProtocol.ts"),
    source!("desktop/src/androidBuildTypes.ts"),
    ...
    source!("desktop/src/candidateEvidence.ts"),
    source!("desktop/src/catalog.ts"),
    source!("desktop/src/certainty.ts"),
    source!("desktop/src/components/AndroidBuild.tsx"),
    ...
    source!("desktop/src/components/OfflinePreflight.tsx"),
    source!("desktop/src/components/ReleaseEvidence.tsx"),
    source!("desktop/src/components/ReleaseInputGuidance.tsx"),
    source!("desktop/src/components/ReleaseVersionEditor.tsx"),
    ...
    source!("desktop/src/lifecycleEvidence.ts"),
    ...
    source!("desktop/src/offlinePreflight.ts"),
    source!("desktop/src/offlinePreflightFindings.ts"),
    source!("desktop/src/offlinePreflightProtocol.ts"),
    source!("desktop/src/offlinePreflightTypes.ts"),
    source!("desktop/src/pages/Artifacts.tsx"),
    ...
    source!("desktop/src/projectPaths.ts"),
    source!("desktop/src/releaseInputGuidance.ts"),
    source!("desktop/src/releaseVersion.ts"),
    source!("desktop/src/releaseVersionEdit.ts"),
    source!("desktop/src/releaseVersionEditController.ts"),
    source!("desktop/src/requirementProtocol.ts"),
    source!("desktop/src/setupGuidance.ts"),
    source!("desktop/src/styles.css"),
    source!("desktop/src/types.ts"),
    source!("desktop/tests/fixtures/candidate-evidence.json"),
    source!("desktop/tests/fixtures/lifecycle-evidence.json"),
    ...
    source!("src/mobile_release/_desktop_android_build_control.py"),
    source!("src/mobile_release/_desktop_android_build_engine.py"),
    source!("src/mobile_release/_desktop_android_build_files.py"),
    source!("src/mobile_release/_desktop_android_build_protocol.py"),
    source!("src/mobile_release/_desktop_android_build_selection.py"),
    ...
    source!("src/mobile_release/_desktop_preflight_budget.py"),
    source!("src/mobile_release/_desktop_preflight_control.py"),
    source!("src/mobile_release/_desktop_preflight_engine.py"),
    source!("src/mobile_release/_desktop_preflight_protocol.py"),
    source!("src/mobile_release/_desktop_saved_command_control.py"),
    source!("src/mobile_release/_desktop_saved_command_engine.py"),
    ...
    source!("src/mobile_release/android_build_operation.py"),
    source!("src/mobile_release/android_build_tools.py"),
    source!("src/mobile_release/android_manifest.py"),
    source!("src/mobile_release/android_upload_validation.py"),
    source!("src/mobile_release/android_zip.py"),
    source!("src/mobile_release/android_zip_integrity.py"),
    ...
    source!("src/mobile_release/api/_lifecycle_evidence.py"),
    ...
    source!("src/mobile_release/api/data/release-version-help-v1.json"),
    ...
    source!("src/mobile_release/desktop_android_build.py"),
    source!("src/mobile_release/desktop_preflight.py"),
    ...
    source!("src/mobile_release/evidence_layout.py"),
    ...
    source!("src/mobile_release/release_version_edit.py"),
    ...
    source!("src/mobile_release/version_text.py"),
