...
export function Dashboard({ session, info, preview, chooseDisabled, refreshReason, onChoose, onRefresh, onNavigate, onHelp }: {
  ...
  const configName = session?.snapshot?.config.path ?? 'mobile-release.json';
