# QA-003 R9 revision 3 — bind profile observations to the files used and removed

## Finding, scope and reanalysis

PROPOSED REVISION 3; no runtime implementation is authorized until independent
plan approval. Supersedes initial R9/R9-R2, retained unchanged. Addresses
independent plan review R9-PR-01/-02 in plan-review-profile-r9/PLAN-REVIEW-R1.md
and the reviewer's R2 installer-borrowed full-stat clarification.
